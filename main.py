...
dir_path = "/Users/web_dev/Desktop/Linkk/"
db_name = 'JOB_Analyser_DB'
tbl_name = 'JOB_Analyser_App_jobdetail'

insert_query = '''INSERT INTO
 JOB_Analyser_App_jobdetail(company,designation,experience,type,salary,
 source,email,website,posted,applied,created,description)
...
def add_new_record(cursor1, r_data):
    jb_detail = (
        r_data['Company'], r_data['Designation'], r_data['Experience'], r_data['JobType'], r_data['Salary'],
        r_data['JOBSource'],
